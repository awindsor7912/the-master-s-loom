...
This project is primarily a hands-on learning initiative focused on:
- understanding app architecture
- designing scalable data models
- exploring frontend/backend integration
- iterating through multiple technology stacks

The end goal is not just a functional app, but a deep understanding of how modern applications are designed and built.
